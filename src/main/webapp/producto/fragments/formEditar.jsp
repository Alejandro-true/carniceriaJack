...
<form action="<%=url%>ProductoController" method="POST" id="formProducto" class="form-carnic" enctype="multipart/form-data" novalidate>
    ...
    <input type="hidden" name="imagenActual" value="<%=producto.getImagenUrl() != null ? producto.getImagenUrl() : ""%>">

    <!-- Info Alert -->
    <div class="info-alert">
        <i class="fas fa-pen-to-square"></i>
        <span>Modificando producto ID: <strong><%=producto.getIdProducto()%></strong></span>
    </div>
    ...
    <div class="image-upload-section">
        <div class="image-preview-container">
            ...
            <div class="image-preview-box" id="imagePreview">
                ...
                %>
                    <img src="<%=request.getContextPath()%>/uploads/productos/<%=imagenUrl%>" alt="Imagen actual" id="previewImg">
                <%
                } else {
                %>
            ...
            <div class="image-upload-controls">
                ...
                <div class="image-current-info">
                    ...
                    Imagen actual: <strong><%=imagenUrl%></strong>
                </div>
                <%
                }
                %>
